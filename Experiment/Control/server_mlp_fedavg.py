...
#Description: FL Server Program for ISCX-VPN 2016 MLP FedAvg
...
MAX_ROUNDS = 3
model_name = "adv1_drop_global_model_fedavg_mlp_3client_36epochs_3round_cpu.h5"
...
class SaveKerasModelStrategy(fl.server.strategy.FedAvg):
    def aggregatex(self, results: List[Tuple[NDArrays, int]]) -> NDArrays:
    ...
    def aggregate_fit(
        ...
        parameters_aggregated = ndarrays_to_parameters(self.aggregatex(weights_results))
