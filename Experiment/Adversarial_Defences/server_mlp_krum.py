...
MAX_ROUNDS = 3
model_name = "adv2_ganc7_global_model_krum_mlp_3client_36epochs_3round_cpu.h5"
...
strategy = SaveKerasModelStrategy(min_available_clients=3, min_fit_clients=3, min_evaluate_clients=3, num_malicious_clients=2) #Set Number of Malicious Client
