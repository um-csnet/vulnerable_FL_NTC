...
#Description: FL Server Program for ISCX-VPN 2016 MLP Trimmed-Mean Filter
...
MAX_ROUNDS = 3
model_name = "adv2_ganc7_global_model_tmx0.3_mlp_3client_36epochs_3round_cpu.h5"
...
class SaveKerasModelStrategy(fl.server.strategy.FedTrimmedAvg):
...
strategy = SaveKerasModelStrategy(min_available_clients=3, min_fit_clients=3, min_evaluate_clients=3, beta=0.3) #Set Trim percentage 
