...
#Description: FL Adversarial Client Program for ISCX-VPN 2016 weighted Averaging
...
#y_train = np.load("y_flip_train-client 3.npy")
y_train = np.load("y_flipfbaudio_train-client 3.npy")
