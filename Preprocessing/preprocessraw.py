...
#save dataset
import numpy as np
np.save('x_train-ISCX-740features', x_train)
np.save('y_train-ISCX-740features', y_train)

np.save('x_test-ISCX-740features', x_test)
np.save('y_test-ISCX-740features', y_test)